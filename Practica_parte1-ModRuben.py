...
driver.find_element_by_xpath('//*[@id="input-10"]').send_keys("España")
driver.find_element_by_xpath('//*[@id="input-10"]').send_keys(Keys.ARROW_DOWN)
driver.find_element_by_xpath('//*[@id="input-10"]').send_keys(Keys.ENTER)
time.sleep(4)
...
#Seleccionar 30 días
driver.find_element_by_xpath('//*[@id="select_option_20"]').click()
...
while True:
    ...
    if siguiente.is_enabled() == False:
        ...
        siguiente.click()
print("Total de resultados:", len(lista))
print("Fin")